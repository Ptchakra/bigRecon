...
from bigRecon.validators import validate_short_name
...
class AddEngineForm(forms.ModelForm):
    ...
    fetch_url = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={}))
...
class UpdateEngineForm(forms.ModelForm):
    ...
    dir_file_search = forms.BooleanField(required=False, widget=forms.CheckboxInput())
    port_scan = forms.BooleanField(required=False, widget=forms.CheckboxInput())
    fetch_url = forms.BooleanField(required=False, widget=forms.CheckboxInput())
    vulnerability_scan = forms.BooleanField(
        required=False, widget=forms.CheckboxInput()
    )
    yaml_configuration = forms.CharField(
